        ...
        <>
            ...
            <Container>
                <Row>
                    <Col>
                        <ProfileImage
                            profileImage={"https://cdn.icon-icons.com/icons2/1369/PNG/512/-account-circle_89831.png"}
                            name={(photographerInfo && photographerInfo.name && photographerInfo.surname) ? `${photographerInfo.name} ${photographerInfo.surname}` : (photographerInfo && photographerInfo.username ? photographerInfo.username : "")}
                            role={"Fotografo"}
                        />
